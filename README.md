# 01 알고리즘 구현으로 배우는 선형대수 with 파이썬		
https://github.com/bjpublic/LinearAlgebra		
		
# 02 명품 C++ Programming (개정판) [개정판]		
https://www.booksr.co.kr/product/%eb%aa%85%ed%92%88-c-programming%ea%b0%9c%ec%a0%95%ed%8c%90/		
		
# 03 Machine Learning Design Patterns		
https://github.com/GoogleCloudPlatform/ml-design-patterns		
		
# 04 Think Bayes 2		
https://allendowney.github.io/ThinkBayes2/index.html		
		
# 05 핸즈온 머신러닝2(주피터 노트북 쟈소 Sciket-learn, Kears, Tensorflow)		
https://github.com/rickiepark/handson-ml2		
		
# 06 statistics-for-data-scientists		
https://github.com/andrewgbruce/statistics-for-data-scientists		
		
# 07 Natural Language Processing with Spark NLP		
https://github.com/jamsuham75/spark-nlp-book		
		
# 08 파이썬 텍스트마이닝 완벽가이드		
https://github.com/wikibook/textmining		
		
# 09 김기현의 자연어 처리 딥러닝 캠프		
https://github.com/kh-kim/nlp_with_pytorch_examples		
		
# 10 파이토치로 배우는 자연어 처리		
https://github.com/rickiepark/nlp-with-pytorch		
		
# 11 모두를 위한 딥러닝 시즌 2 - PyTorch		
